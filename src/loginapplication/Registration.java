...
//               String role = c1.getSelectedItem();
        ...
        if(ae.getSource() == b1){
            ...
            try{
                ...
                if(rs.next()){
                    ...
                    JOptionPane.showMessageDialog(null, "Account creation unsuccessful, Username have been used! ");

                }else{
                    str = "insert into login values('"+username+"', '"+name+"', '"+password+"', '"+role+"')";
